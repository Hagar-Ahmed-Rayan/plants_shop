  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
        ...
        create: (context) => ShopLoginCubit()
          //..showproductsinfo(token: TOKEN),
    //  ..showproductsinfo(token: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiIzMGYwM2Q3Mi04NTNlLTQ1MTItYWQwMi01YzAyYjkwMmRjZGMiLCJyZWZyZXNoIjp0cnVlLCJpYXQiOjE2NjA3ODc3NzUsImV4cCI6MTY2MTM5MjU3NX0.EPeOpmUe0rX7Lofjok5VyOK8odbBU7J8y5NfENCvlgk')
